...
static const char *altbarcmd = "$HOME/.dwm/polybar/bar.sh";
static char *fonts[] = {"Terminus:size=13",
                        "Terminus:pixelsize=13:antialias=true:autohint=true"};
...
const char *spcmd2[] = {TERMINAL, "-n",    "spcalc", "-f", "Iosevka:size=16",
                        "-g",     "50x20", "-e",     "bc", "-lq",
                        NULL};
...
static Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_q, spawn, SHCMD("/usr/bin/killdwm.sh")},
    /*applications*/
    ...
    {MODKEY | ShiftMask,
     XK_q,
     spawn,
     {.v = (const char *[]){"whatsapp-for-linux", NULL}}},
    ...
    {MODKEY, XK_s, spawn, SHCMD("$HOME/.dwm/scripts/powermenu.sh")},
    /* { MODKEY|ShiftMask,		XK_s,		spawn, SHCMD("")
     * },
     */
    {MODKEY, XK_d, spawn, SHCMD("$HOME/.dwm/scripts/launcher.sh")},
    /* { MODKEY|ShiftMask,		XK_d,		spawn,		{.v =
       (const char*[]){ "passmenu", NULL } } }, */
    ...
    {MODKEY, XK_n, spawn, SHCMD("$HOME/.dwm/scripts/network.sh")},
    {MODKEY,
     XK_m,
     spawn,
    ...
    {MODKEY | ShiftMask,
     XK_m,
     spawn,
     {.v = (const char *[]){"pamixer", "--toggle-mute", NULL}}},
    ...
    {ShiftMask,
     XK_Print,
     spawn,
     {.v = (const char *[]){"takeshot", "--area", NULL}}},
    {0, XF86XK_AudioMute, spawn, SHCMD("/usr/bin/dwmDunstVol toggle")},
    {0, XF86XK_AudioRaiseVolume, spawn, SHCMD("/usr/bin/dwmDunstVol +5%")},
    {0, XF86XK_AudioLowerVolume, spawn, SHCMD("/usr/bin/dwmDunstVol -5%")},
    {MODKEY, XK_equal, spawn, SHCMD("/usr/bin/dwmDunstVol +5%")},
    {MODKEY, XK_minus, spawn, SHCMD("/usr/bin/bin/dwmDunstVol -5%")},
    ...
    {0, XF86XK_PowerOff, spawn, SHCMD("betterlockscreen --lock --off 5")},
    {0,
     XF86XK_Calculator,
     spawn,
    ...
    /*	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("slock & xset dpms
       force off; mpc pause; pauseallmpv") },*/
    {0, XF86XK_ScreenSaver, spawn, SHCMD("betterlockscreen --lock --off 5")},
    {0,
     XF86XK_TaskPane,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", "htop", NULL}}},
